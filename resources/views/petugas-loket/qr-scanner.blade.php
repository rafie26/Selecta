    ...
    <div class="col-md-8 mx-auto">
        <div class="card">
            <div class="card-body text-center py-5">
                <i class="fas fa-qrcode fa-5x text-success mb-4"></i>
                <h3 class="mb-3">QR Code Scanner</h3>
                <p class="text-muted mb-4">
                    Scan QR code dari tiket pengunjung untuk melakukan check-in
                </p>
                <a href="{{ route('qr.scanner') }}" class="btn btn-success btn-lg">
        ...
        <div class="card mt-4">
            <div class="card-body">
                ...
                <ol class="mb-0">
                    ...
                    <li class="mb-2">Arahkan kamera ke QR code pada tiket</li>
                    <li class="mb-2">Sistem akan otomatis membaca dan memproses check-in</li>
                    <li>Konfirmasi status check-in pengunjung</li>
                </ol>
            </div>
        </div>
    </div>
