...
<body>
    ...
    <div class="left-content">
        ...
        <h1 class="main-heading">Welcome<br>Traveler</h1>
        <p class="subtitle">Bergabunglah dengan Komunitas Wisatawan Selecta</p>
        <p class="description">
            Masuk ke akun Anda untuk menikmati pengalaman booking yang lebih personal, 
            melihat riwayat perjalanan, dan mendapatkan penawaran eksklusif khusus untuk Anda.
        </p>
    </div>
