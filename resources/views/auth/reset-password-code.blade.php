...
<head>
    ...
    <title>Verifikasi Kode OTP - Selecta Wisata</title>
...
<body>
    ...
    <div class="auth-container">
        <form class="auth-form" method="POST" action="{{ route('password.reset.code.submit') }}" onsubmit="handleReset(event)">
            @csrf
            <h2>Verifikasi Kode OTP</h2>
            <p class="subtitle">Kami telah mengirim kode OTP ke email Anda. Masukkan kode tersebut dan buat kata sandi baru.</p>
    ...
    <script>
        function handleReset(event) {
            ...
            if (password !== passwordConfirmation) {
                document.getElementById('passwordConfirmationError').textContent = 'Konfirmasi kata sandi tidak cocok';
                return;
            }
            ...
            .catch(error => {
                ...
                document.getElementById('codeError').textContent = 'Terjadi kesalahan. Silakan coba lagi.';
            })
            .finally(() => {
        ...
        function clearErrors() {
            const ids = ['emailError', 'codeError', 'passwordError', 'passwordConfirmationError'];
            ids.forEach(id => {
